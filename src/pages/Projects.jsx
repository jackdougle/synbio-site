    ...
    return(
      <AnimWrapper>
        <div className="flex flex-col font-mono bg-gradient-to-r from-purple-400 to-green-400 bg-clip-text text-transparent font-extrabold mx-6 my-2">
            <p className="text-[40px] md:text-[70px] bg-gradient-to-r from-blue-400 to-red-500 bg-clip-text text-transparent -mt-2">Our Work</p>
            <p className="text-gray-800 text-2xl translate-x-1">Showcase of individual and team projects</p>
        </div>
