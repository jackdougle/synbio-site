...
function Projects() {
    ...
    <div className="relative grid grid-cols-[320px_auto] min-h-screen w-screen overflow-hidden">
      ...
      <div className="col-start-2 overflow-y-scroll bg-white">
        ...
        <div className="max-w-full flex flex-wrap justify-around mx-10 my-8 gap-10">
            <div className="flex flex-col min-h-100 min-w-85 bg-black rounded-4xl border-5 border-black transition duration-200 hover:scale-102" onClick={() => window.location.href = "projects/molecularthesaurus"}>
            ...
            <div className="flex flex-col min-h-100 min-w-85 bg-black rounded-4xl border-5 border-black transition duration-200 hover:scale-102" onClick={() => window.location.href = "projects/rustktd"}>
            ...
            <div className="flex flex-col min-h-100 min-w-85 bg-black rounded-4xl border-5 border-black transition duration-200 hover:scale-102" onClick={() => window.location.href =  "projects/2026"}>
