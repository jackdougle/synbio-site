      ...
      <AnimWrapper>
        <div className="flex flex-col ml-6 mr-12 my-2 text-[20px] font-sans font-light">
          ...
          <div className="my-5">
            ...
            <p className="mx-2 mt-1">We’re eager to partner with organizations aligned with our mission. Sponsor support help fund research, travel, and equipment costs. For any inquiries, please send us an email!</p>
          </div>
