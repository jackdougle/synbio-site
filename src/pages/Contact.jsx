    ...
    return(
      <AnimWrapper>
        <div className="flex flex-col ml-6 mr-12 my-2 text-[20px] font-sans font-light">
          <p className="text-[35px] md:text-[70px] bg-gradient-to-r from-blue-400 to-red-500 bg-clip-text text-transparent -my-2 -mb-6 font-extrabold font-mono">Contact Us</p>
          <div id="apply">
          ...
          <p className="m-2 mt-2">Our email: <strong className="text-sky-500 font-mono font-bold text-lg hover:text-sky-300 transition duration-300">uasynbio@gmail.com</strong></p><br />
