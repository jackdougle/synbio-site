...
function MolThesaurus() {
    ...
    <AnimWrapper>
      <div className="flex flex-col font-mono bg-gradient-to-r from-purple-400 to-green-400 bg-clip-text text-transparent my-2 mx-6 mr-6">
        <p className="text-[35px] md:text-[70px] bg-gradient-to-r from-blue-400 to-red-500 bg-clip-text text-transparent -my-2 font-bold">Molecular Thesaurus</p>
        <p className="text-gray-800 text-2xl translate-x-1 font-bold">A cheminformatics website streamlining molecular information gathering</p>
      </div>
